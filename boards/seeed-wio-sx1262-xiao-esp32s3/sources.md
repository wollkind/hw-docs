...
- Fetched 2026-09-22 from `https://files.seeedstudio.com/products/SenseCAP/Wio_SX1262/`:
  - `Wio-SX1262_Module_Datasheet.pdf` → `datasheets/wio-sx1262-module.pdf`
  - `Wio-SX1262-N_Module_Datasheet.pdf` → `datasheets/wio-sx1262-n-module.pdf`
  - `Schematic_Diagram_Wio-SX1262_for_XIAO.pdf` → `hardware/schematic.pdf`
  - `Wio-SX1262_for_XIAO_3D_file.step` → `hardware/3d-model.step.gz` (gzipped, 3.7 MB raw)
- The schematic's GPIO labels do not match the Meshtastic variant's pin numbers, and its text layer does not pair labels with pins. See the note under "Pinout" in `README.md`; settling it needs the PDF read by eye.
