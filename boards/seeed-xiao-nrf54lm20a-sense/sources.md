...
- Fetched 2026-09-22, once `files.seeedstudio.com` became reachable:
  - https://files.seeedstudio.com/wiki/XIAO_nRF54LM20A/getting_start/RES/XIAO_nRF54LM20A_Schematic.pdf → `hardware/schematic.pdf`
