...
- Not copied: 3D models (Plus: GrabCAD login only; S3/Sense: `res/seeed-studio-xiao-esp32s3*-3d_model.zip`), camera datasheets (`res/OV2640_datasheet.pdf`, `OV3660_datasheet.pdf`, `OV5640_datasheet.pdf` and the two `new-res/OV*_Camera_Module_Specification.pdf`), factory firmware, KiCad footprint libraries, and the plain-S3 `202003751_…_SCH&PCB_260226.zip`.
